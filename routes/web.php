    ...
    Route::middleware('front.data.share')->group(function ()
{
    ...
    Route::get('/blogs/{category}', 'BlogController@getCategory')->name('blog.category');
    Route::get('/blog/search{category}/{post}', 'BlogController@post')->name('blog.post');
//    Route::get('/blog/search', 'BlogController@search')->name('blog.search');
    Route::post('/blog','BlogController@saveComment')->name('comment.save');
...
Route::prefix('admin')->middleware('auth')->group(function ()
{
    ...
    Route::post('menu/edit-order', 'Admin\MenuController@editOrder')->name('menu.editOrder');

    Route::get('comment', 'Admin\CommentController@index')->name('comment.index');
    Route::post('comment', 'Admin\CommentController@delete')->name('comment.delete');
